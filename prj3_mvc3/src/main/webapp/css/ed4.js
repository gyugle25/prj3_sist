			...
			on: function(b, d, h, k, g) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					for (var w = e.length - 1; 0 <= w; w--)
						if (e[w].priority <= g) return e.splice(w + 1, 0, l), {
							removeListener: v
						};
					e.unshift(l)
				}
			...
			enlarge: function(a, b) {
				...
				switch (a) {
										...
										if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
											...
											if (d.test(N)) n = null;
												...
												for (var q = n.$.getElementsByTagName("*"), D = 0, r; r = q[D++];)
													if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) {
														n = null;
														break
													} n && (B = !!N.length)
										} else n = null;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						var x, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
								br: 1
							} : null),
							t = null,
							P = function(a) {
				...
				for (this._.nextNode = null; m;) {
					...
					if (G) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (G = 0);
						...
						if (CKEDITOR.dtd.$block[n] && "false" == m.getAttribute("contenteditable")) {
							...
							b(this, a, d);
							break
						} else if (m.isBlockBoundary(this.forceBrBreak && !y && {
								br: 1
							})) {
							if ("br" == n) G = 1;
					...
					if (k && !M)
						for (; !m.getNext(g) && !w;) {
							n = m.getParent();
							if (n.isBlockBoundary(this.forceBrBreak && !y && {
									br: 1
								})) {
								M = 1;
								G = 0;
	...
	(function() {
		...
		function A(a, b, f, e) {
			...
			if (e.doFilter) {
				...
				if (!e.skipFinalValidation && !m(b)) return f.push(b),
				1
			}
				...
				if ("br" == b) a.previous && !G(a.previous) && (b = y(), b.insertBefore(a)), a.next && !G(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
					...
					b: {
						...
						for (var e = 0, n = d.length, p; e < n; ++e)
							if (p = d[e], p.type == CKEDITOR.NODE_ELEMENT && !f[p.name]) {
								f = !1;
								break b
							} f = !0
					}
		...
		function C(a, b) {
			...
			for (e in d)
				if ("class" == e)
					for (c = d[e].split(/\s+/), p = a.classes.join("|"); r = c.pop();) {
	...
	(function() {
		...
		CKEDITOR.inlineAll = function() {
			...
			for (b in CKEDITOR.dtd.$editable)
				for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count(); f < h; f++) a = c.getItem(f), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = {
					element: a,
					config: {}
		...
		m = function() {
			...
			function b(c, d) {
				...
				for (var k = r[k.getName()], D = 0, x = c.getChildren(), l = x.count(), m = -1, B = -1, v = 0, T = e.contains(r.$list); D <
					...
					node: e,
					allowed: 1
				}); - 1 < m && (h[m].firstNotAllowed = 1); - 1 < B && (h[B].lastNotAllowed = 1);
				return h
			}
			...
			getRanges: function() {
				var a = m ? function() {
					...
					var b = function(b, c) {
						...
						return {
							container: r,
							offset: 0 < q ? -h : r.nodeValue.length + h
						}
					};
					return function() {
			...
			selectRanges: function(a) {
				...
				if (a.length)
					if (this.isLocked) {
						...
						if (t) this.fake(t);
						else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !H && !a[0]._getTableElement({
								table: 1
	...
	*/
			...
			init: function(a) {
				function b(d) {
					...
					var B = new CKEDITOR.style(r["colorButton_" + h + "Style"]),
						...
						u = l.getRowLimit(a) ? new l(a, "back" == h ? "background-color" : "color", w) : void 0,
						t;
					a.addCommand(m, {
						contextSensitive: !0,
						exec: function(a, d) {
				...
				function c(b, c, f) {
					...
					f = h.length + f + (k ? 1 : 0);
					var p = 1;
					r.colorButton_enableAutomatic && (f += 1, p += 1, g.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', n.auto, '"', ' draggable\x3d"false"', ' ondragstart\x3d"return false;"', ' onclick\x3d"CKEDITOR.tools.callFunction(',
					...
					k && g.push("\x3c/tr\x3e", "\x3ctr\x3e", '\x3ctd colspan\x3d"', a.config.colorButton_colorsPerRow, '" align\x3d"center"\x3e', '\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', n.more, '"', ' draggable\x3d"false"', ' ondragstart\x3d"return false;"',
						' onclick\x3d"CKEDITOR.tools.callFunction(', c, ",'?');return false;\"", " href\x3d\"javascript:void('", n.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', f, '" aria-setsize\x3d"', f, '"\x3e', n.more, "\x3c/a\x3e", "\x3c/td\x3e");
				...
				function v(a, b) {
					...
					if (f) f.setAttribute("aria-selected", !0);
						...
						for (g = 0; g < c.count(); g++)
							if (f = c.getItem(g), b && b == p(f.getAttribute("data-value"))) {
				...
				if (!CKEDITOR.env.hc) {
					...
					var k, w = a.config.colorButton_normalizeBackground;
					if (void 0 === w || w) k = [
						[{
							element: "span",
							left: function(a) {
		...
		k = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				addNewColor: function(a) {
					...
					this.getElement().append(a.getElement(),
						!0)
				},
		...
		l = CKEDITOR.tools.createClass({
			...
			_: {
				countColors: function() {
					...
					return CKEDITOR.tools.array.reduce(a,
						function(a, c) {
				...
				getHexCode: function(a, b, c) {
					var f = a.getStyle(b);
					return f in c ? c[f].substr(1) : this._.normalizeColor(a.getComputedStyle(b)).toUpperCase()
				},
				...
				createAtBeginning: function(a) {
					this._.moveToBeginning(new q(this.editor, {
						color: a
					}, this.clickFn))
				},
				addNewRow: function() {
				...
				alignRows: function() {
					for (var a = 0; a < l.getRowLimit(this.editor) && !(this.rows[a].boxes.length <= this.editor.config.colorButton_colorsPerRow); a++) this.rows[a + 1] ? this._.moveLastBoxToNextRow(a) : a < l.getRowLimit(this.editor) - 1 ? (this._.addNewRow(), this._.moveLastBoxToNextRow(a)) : this.rows[a].removeLastColor()
				},
			...
			proto: {
				...
				renderContentColors: function() {
					...
					CKEDITOR.tools.isEmpty(a) || (a = this._.sortByOccurrencesAscending(a,
	...
	(function() {
		...
		CKEDITOR.plugins.add("editorplaceholder", {
			...
			init: function(b) {
				this.isSupportedEnvironment() && b.config.editorplaceholder && d(b, ["contentDom", "focus", "blur", "change"])
			}
		});
	...
	(function(d) {
		...
		c.c = a;
		c.d = function(g, a, e) {
			if (!c.o(g, a)) Object[a0_0x135c("0x18")](g, a, {
				enumerable: !0,
				get: e
			})
		};
		c.r = function(a) {
			if ("undefined" !== typeof Symbol && Symbol[a0_0x135c("0x70")]) Object[a0_0x135c("0x18")](a, Symbol[a0_0x135c("0x70")], {
				value: "Module"
			});
			Object[a0_0x135c("0x18")](a, a0_0x135c("0x5a"), {
				value: !0
			})
		};
		c.t = function(a,
			b) {
			b & 1 && (a = c(a));
			if (b & 8 || b & 4 && typeof a === a0_0x135c("0x19") && a && a.__esModule) return a;
		...
		c.n = function(a) {
			var b = a && a[a0_0x135c("0x5a")] ? function() {
		...
		(function() {
			CKEDITOR[a0_0x135c("0x11")][a0_0x135c("0x36")](a0_0x135c("0x2e"), {
				...
				beforeInit: function(a) {
					...
					b[a0_0x135c("0x59")]();
					a.on(a0_0x135c("0x24"), function(a) {
						a[a0_0x135c("0xa")][a0_0x135c("0x21")] = b.token
					}, null, null, 16)
				},
				init: function(a) {
					function c() {
						return a[a0_0x135c("0x11")][a0_0x135c("0x44")] ? a[a0_0x135c("0x4b")][a0_0x135c("0x45")](a, arguments) : {
							update: function() {},
							hide: function() {}
						}
					}
					...
					function b(f) {
						if (!a[a0_0x135c("0x51")][a0_0x135c("0x7")][a0_0x135c("0x9")] && !a[a0_0x135c("0x4")]().isInline()) {
							...
							f = f.$.styleSheets;
							try {
								CKEDITOR[a0_0x135c("0x29")][a0_0x135c("0x49")][a0_0x135c("0x1b")](f, function(a) {
									CKEDITOR.tools[a0_0x135c("0x49")][a0_0x135c("0x1b")](a[a0_0x135c("0x5")], function(a) {
					...
					function e(a) {
						...
						a[a0_0x135c("0x1b")](function(a) {
							a[a0_0x135c("0x2c")] === a0_0x135c("0x10") && (a[a0_0x135c("0x38")][a0_0x135c("0x4f")] = l(a[a0_0x135c("0x38")][a0_0x135c("0x4f")]))
						}, CKEDITOR[a0_0x135c("0x50")], !1);
						a[a0_0x135c("0x53")](b);
					...
					function d(b, c) {
						...
						b[a0_0x135c("0x3d")](a0_0x135c("0x52"), function() {
							b[a0_0x135c("0x14")] == a0_0x135c("0x1f") ? (CKEDITOR[a0_0x135c("0x11")][a0_0x135c("0x2e")][a0_0x135c("0x13")](h(), b[a0_0x135c("0x25")]), c.update({
								message: a[a0_0x135c("0x2a")][a0_0x135c("0x2e")][a0_0x135c("0x16")],
								type: a0_0x135c("0x62"),
								duration: 3E3,
								progress: 1
							})) : (m(b[a0_0x135c("0x25")]), c[a0_0x135c("0x5d")](), a[a0_0x135c("0x4b")](a[a0_0x135c("0x2a")][a0_0x135c("0x2e")].error, a0_0x135c("0x2f")));
					...
					function h() {
						var b =
							a[a0_0x135c("0x51")][a0_0x135c("0x47")];
					...
					function m(a) {
						if (a) {
							...
							b[a0_0x135c("0x3d")](a0_0x135c("0x52"), function(a) {
								a = JSON[a0_0x135c("0x30")](a[a0_0x135c("0x3a")][a0_0x135c("0x1d")]);
					...
					if (this[a0_0x135c("0x4e")]() && (a[a0_0x135c("0x69")]("exportPdf", {
							exec: function(f) {
								...
								this[a0_0x135c("0x3f")]();
								f[a0_0x135c("0x57")]("exportPdf", function(b) {
									k.update({
										progress: .2
									});
									b[a0_0x135c("0xa")].html = e(b[a0_0x135c("0xa")][a0_0x135c("0x4c")]);
									var c = b[a0_0x135c("0xa")],
										d = a0_0x135c("0x4c");
									b = b[a0_0x135c("0xa")].html;
									var g = f[a0_0x135c("0x4")]()[a0_0x135c("0xe")](!0);
									b = (a[a0_0x135c("0x51")].exportPdf_stylesheets[a0_0x135c("0x9")] ? CKEDITOR.tools[a0_0x135c("0x8")](CKEDITOR[a0_0x135c("0x29")].array[a0_0x135c("0x34")](a[a0_0x135c("0x51")][a0_0x135c("0x7")],
										l)) : "") + a0_0x135c("0x28") + g + '"\x3e' + b + "\x3c/div\x3e";
									c[d] = b
								}, null, null, 15);
								f[a0_0x135c("0x57")](a0_0x135c("0x24"), function(b) {
									...
									var e = new XMLHttpRequest,
										h = a[a0_0x135c("0x51")][a0_0x135c("0xf")] || a0_0x135c("0x6a");
									e.open("POST", g);
									e[a0_0x135c("0x37")]("Content-type", "application/json");
									e[a0_0x135c("0x37")](a0_0x135c("0x1"), h);
									if (c) e[a0_0x135c("0x37")](a0_0x135c("0xd"),
										c);
							...
							readOnly: 1,
							canUndo: !1
						}), a.ui.addButton)) a.ui[a0_0x135c("0x46")](a0_0x135c("0x0"), {
					...
					var b = {
						...
						fetchToken: function() {
							...
							a[a0_0x135c("0x3d")]("loadend", function() {
								a[a0_0x135c("0x1c")] && (b[a0_0x135c("0x21")] = a[a0_0x135c("0x1c")])
							});
							a[a0_0x135c("0x33")]()
						},
						init: function() {
							if (c) {
								this[a0_0x135c("0xb")]();
								var b = window[a0_0x135c("0x60")](this[a0_0x135c("0xb")], this.refreshInterval);
			...
			CKEDITOR[a0_0x135c("0x11")][a0_0x135c("0x2e")] = {
				downloadFile: function(a, c) {
					...
					} else b = CKEDITOR[a0_0x135c("0x23")][a0_0x135c("0x27")]("a", {
						attributes: {
							href: window[a0_0x135c("0x26")].createObjectURL(c),
							download: a
						}
					}), b.$[a0_0x135c("0x55")](), b[a0_0x135c("0x1e")](), window[a0_0x135c("0x26")][a0_0x135c("0xc")](b[a0_0x135c("0x5f")](a0_0x135c("0x4a")))
				}
			}
		})();
			...
			proto: {
				...
				render: function(a, b) {
					...
					this._.listeners.push(a.on("activeFilterChange",
						d, this));
					this._.listeners.push(a.on("mode", d, this));
					this._.listeners.push(a.on("selectionChange", d, this));
					!this.readOnly && this._.listeners.push(a.on("readOnly", d, this));
					...
					if (d || c)
						if (d && e.collapsed && m({
							...
							if (e = d) e = d instanceof CKEDITOR.style && c instanceof CKEDITOR.style ? CKEDITOR.style.getStyleText(d.getDefinition()) ===
								CKEDITOR.style.getStyleText(c.getDefinition()) : !1, e = !e;
							e && a.removeStyle(d);
							a.applyStyle(c)
						}
				},
				refresh: function(a, b) {
					e.checkApplicable(b, a, a.activeFilter) || this.setState(CKEDITOR.TRISTATE_DISABLED)
				}
			});
			...
			a.ui.addRichCombo(b.comboName, {
				...
				onRender: function() {
					a.on("selectionChange", function(c) {
						var d = this.getValue();
						(c = f.getMatchingValue(a, c.data.path)) ? c != d && this.setValue(c): this.setValue("",
							b.defaultLabel)
					}, this);
					g.on("state", function() {
		...
		function m(a) {
			...
			if (a = e.contains(function(a) {
				...
				if (f && g) {
					...
					a.remove();
					c.moveToBookmark(f)
				} else f || g ? c.moveToPosition(a, f ? CKEDITOR.POSITION_BEFORE_START :
					CKEDITOR.POSITION_AFTER_END) : (c.splitElement(a), c.moveToPosition(a, CKEDITOR.POSITION_AFTER_END)), h(c, e.elements.slice(), a);
